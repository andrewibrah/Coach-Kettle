  ...
  function SectionTitle({
    ...
    return (
      <h2 className="mb-4 flex items-center gap-3 text-lg font-bold text-brand-text">
        <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/[0.06] text-[0.8rem] font-extrabold
  lowercase text-brand-accent">
          {letter}
        </span>
        {children}
      </h2>
    ...
    return (
      <>
        ...
        <div className="mx-auto max-w-[860px] px-6 pb-16 pt-12">
          <Link
            to="/"
            className="mb-10 inline-flex items-center gap-1 text-sm font-semibold text-brand-accent no-underline transition-opacity
  hover:opacity-80"
          >
            &larr; Back to Home
          </Link>
          ...
          <Section>
            ...
            <p className="text-sm text-brand-muted">
              ...
              may not transfer, redistribute or sublicense the Licensed
              Application and, if you sell your Apple Device to a third party, you
              must remove the Licensed Application from the Apple Device before
              doing so. You may not copy (except as permitted by this license and
              the Usage Rules), reverse-engineer, disassemble, attempt to derive
              the source code of, modify, or create derivative works of the
              Licensed Application, any updates, or any part thereof (except as
          ...
          <Section>
            ...
            <p className="text-sm text-brand-muted">
              ...
              Services at your sole risk. Licensor is not responsible for
          ...
          <Section>
            ...
            <Highlight>
              This section keeps the standard Apple disclaimer language intact and
              is visually emphasized because it carries the main warranty
              limitation for the licensed application.
            </Highlight>
          </Section>
          ...
          <Section>
            <SectionTitle letter="g">Export Compliance</SectionTitle>
            <p className="text-sm text-brand-muted">
          ...
          <Section>
            <SectionTitle letter="h">U.S. Government End Users</SectionTitle>
            <p className="text-sm text-brand-muted">
              The Licensed Application and related documentation are
              &quot;Commercial Items&quot;, as that term is defined at 48 C.F.R.
              Section 2.101, consisting of &quot;Commercial Computer
              Software&quot; and &quot;Commercial Computer Software
              Documentation&quot;, as such terms are used in 48 C.F.R. Section
              12.212 or 48 C.F.R. Section 227.7202, as applicable. Consistent
              with 48 C.F.R. Section 12.212 or 48 C.F.R. Section 227.7202-1
          ...
          <Section>
            <SectionTitle letter="i">Governing Law</SectionTitle>
            <p className="mb-3 text-sm text-brand-muted">
              ...
              you do not reside in the U.S.; (c) you are not accessing the
              Service from the U.S.; and (d) you are a citizen of one of the
              countries identified below, you hereby agree that any dispute or
              claim arising from this Agreement shall be governed by the
              applicable law set forth below, without regard to any conflict of
              law provisions, and you hereby irrevocably submit to the
          ...
          <Section>
            <div className="flex items-center gap-3 text-sm text-brand-muted">
              <span
                aria-hidden="true"
                className="text-xl leading-none text-brand-text"
              >
                &#63743;
              </span>
              <span>Apple</span>
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-1 text-sm font-semibold text-brand-accent no-underline transition-opacity
  hover:opacity-80"
          >
            &larr; Back to Home
          </Link>
