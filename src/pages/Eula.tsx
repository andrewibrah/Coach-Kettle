...
function Highlight({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-4 rounded-xl border border-white/[0.08] bg-white/[0.03] px-5 py-4">
      ...
      <div className="mx-auto max-w-[860px] px-6 pb-16 pt-12">
        ...
        <Section>
          ...
          <p className="text-sm text-brand-muted">
            ...
            &sect;2.101, consisting of &quot;Commercial Computer
            Software&quot; and &quot;Commercial Computer Software
            Documentation&quot;, as such terms are used in 48 C.F.R. &sect;12.212
            or 48 C.F.R. &sect;227.7202, as applicable. Consistent
            with 48 C.F.R. &sect;12.212 or 48 C.F.R. &sect;227.7202-1
