  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col text-left leading-tight">
        {/* Black at 50% on white (#808080) was 3.98:1 — fails SC 1.4.3 at
            9.6px. 60% (#666666) = 5.74:1. */}
        <small className="text-[0.6rem] font-medium uppercase tracking-wider opacity-60">
          Download on the
        </small>
