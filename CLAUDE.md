...
Technical brief → `.claude/claude.md`
...
This project is indexed by GitNexus as **WorkoutTracker** (2424 symbols, 6026 relationships, 197 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
